...
```
api_valorant/
├── api/                     # Gestion des appels API et des données
│   ├── api.go
│   ├── characters.go
│   ├── weapons.go
│   ├── endpoints.go
...
│   ├── filters.go
│   ├── search.go
├── templates/               # Templates HTML pour les pages web
│   ├── login.html
│   ├── characters.html
│   ├── weapons.html
│   ├── search.html
...
1. Clonez le projet :
   ```bash
   git clone https://github.com/votre-utilisateur/api_valorant.git
   cd api_valorant
   ```
...
## **Auteur**
Ce projet a été réalisé par **[Votre Nom/Équipe]** dans le cadre d'un projet pédagogique. Si vous avez des questions ou des suggestions, n'hésitez pas à me contacter.
